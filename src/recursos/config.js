...
export const infoCard = [{
    ...
    imagen: hp,
    descripcion: 'App para practicar habilidades de Tipeo con temática de Harry Potter. Hecho con React y Bootstrap',
...
}, 
{
    ...
    imagen: feriados,
    descripcion: 'App para ver los próximos feriados de Argentina, y también los que pasaron. Hecho con React, Sass, etc.',
